...
public interface StudentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>training.demo.search.container.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the student local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StudentLocalServiceUtil} if injection and service tracking are not available.
	 */
