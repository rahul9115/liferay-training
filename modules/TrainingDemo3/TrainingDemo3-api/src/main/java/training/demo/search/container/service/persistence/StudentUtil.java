...
package training.demo.search.container.service.persistence;
...
public class StudentUtil {
	...
	public static Student remove(long StudentId)
		throws training.demo.search.container.exception.NoSuchStudentException {
