...
package training.demo.search.container.service.persistence.impl;
...
import training.demo.search.container.exception.NoSuchStudentException;
import training.demo.search.container.model.Student;
import training.demo.search.container.model.StudentTable;
import training.demo.search.container.model.impl.StudentImpl;
import training.demo.search.container.model.impl.StudentModelImpl;
import training.demo.search.container.service.persistence.StudentPersistence;
import training.demo.search.container.service.persistence.StudentUtil;
import training.demo.search.container.service.persistence.impl.constants.TrainingDemoSearchContainerPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	@Override
	@Reference(
		target = TrainingDemoSearchContainerPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = TrainingDemoSearchContainerPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
