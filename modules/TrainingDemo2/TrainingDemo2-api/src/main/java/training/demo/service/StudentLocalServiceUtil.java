 ...
 * <code>training.demo.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>training.demo.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Student edit(
			long studentId, String name, String mobileno, String email)
		throws PortalException {

		return getService().edit(studentId, name, mobileno, email);
	}
